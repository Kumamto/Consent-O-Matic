...
function fetchRules(forceUpdate) {
    ...
    let rulePromise = new Promise((resolve, reject) => {
        GDPRConfig.getRuleLists().then((ruleLists) => {
            ...
            let oldDefaultListIndex = ruleLists.indexOf("https://raw.githubusercontent.com/Kumamto/Consent-O-Matic/master/Rules.json");

            if(oldDefaultListIndex !== -1) {
                console.log("Cleaning old rule list, and replacing with new reference based list...");
                ruleLists[oldDefaultListIndex] = "https://raw.githubusercontent.com/Kumamto/Consent-O-Matic/master/rules-list.json"
